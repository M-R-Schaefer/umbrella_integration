...
try:
    ...
    print(
        "KDE will be omitted from window distribution plot due to missing scipy library."
    )
    CAN_PLOT_KDE = False
...
def plot_with_kde(
    ax, xs, ys, xlabel=None, ylabel=None, label=None, show=True, kde=None, color="blue"
):
